...
export default function BangBienSection() {
    ...
    return (
        <section id="bang-bien" className="py-16 md:py-24 bg-slate-50 border-b border-slate-100">
            <div className="max-w-[1280px] mx-auto px-6 md:px-8">
                ...
                <div className="mt-12 text-center">
                    ...
                    >
                        Xem thêm tất cả bảng biển chỉ dẫn
