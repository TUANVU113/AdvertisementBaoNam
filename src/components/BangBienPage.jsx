...
import { products } from '../data/BangBien';


export default function BangBienPage() {
            ...
            <section className="py-12 md:py-20 bg-white min-h-screen">
                <div className="max-w-[1280px] mx-auto px-6 md:px-8">
                    ...
                    <nav className="flex items-center gap-2 text-xs md:text-sm text-slate-500 mb-8">
                        ...
                        <span className="text-primary font-semibold">Bảng Biển</span>
                    </nav>
                    ...
                    <div className="text-center mb-12 md:mb-16">
                        ...
                        <p className="text-slate-600 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
                            Cung cấp đa dạng các loại bảng biển tên công ty, biển chỉ dẫn, biển phòng ban với chất liệu cao cấp và thiết kế tinh tế.
                        </p>
